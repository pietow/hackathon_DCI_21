...
1. Clone this repository into a new project folder (replace `[project name]` with your project's name)
   ...
   ```
   git clone https://github.com/FbW-E05-1/project-boilerplate.git [project name]
   ```
...
Updated in July 2021 by André Kleinschmidt ([@andredci](https://github.com/andredci))
